...
- [Contributing](./contributing/README.md)
    - [Contributing to NiWrap](./contributing/contributing_to_niwrap.md)
    - [Automated descriptor creation in NiWrap](./contributing/automated_descriptor_creation.md)
    - [Contributing to the Styx compiler](./contributing/styx_compiler.md)
